<div class="row g-3">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="email" name="email" id="email" class="form-control rounded-pill @error('email') is-invalid @enderror"
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select name="role" id="role" class="form-control rounded-pill @error('role') is-invalid @enderror" required>
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select name="department" id="department" class="form-control rounded-pill @error('department') is-invalid @enderror">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select name="level" id="level" class="form-control rounded-pill @error('level') is-invalid @enderror" required>
